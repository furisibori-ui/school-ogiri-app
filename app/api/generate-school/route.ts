...
// 画像生成ヘルパー関数
async function generateImage(prompt: string, landmark: string): Promise<string> {
  try {
    const response = await fetch(`${process.env.NEXT_PUBLIC_BASE_URL || 'http://localhost:3000'}/api/generate-image`, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({ prompt, landmark }),
    })
    const data = await response.json()
    return data.url
  } catch (error) {
    console.error('Image generation failed:', error)
    return 'https://placehold.co/600x400/CCCCCC/666666?text=Image+Failed'
  }
}
...
function generateRandomStyleConfig(): StyleConfig {
  ...
  const middleSections = ['anthem', 'rules', 'events', 'clubs'] // 中盤はシャッフル
  const bottomSections = ['facilities', 'monuments', 'uniforms', 'history'] // 後半はシャッフル
...
function generateMockSchoolData(location: LocationData): SchoolData {
  ...
  return {
    ...
    principal_message: {
      name: '清水 誠一郎',
      title: '校長',
      text: `本校ホームページをご覧いただき、誠にありがとうございます。校長の清水誠一郎でございます。\n\n${schoolName}は、明治39年の創立以来、実に120年という長い歴史の中で、${address}の地において、常に地域社会と密接に連携しながら、質の高い教育を実践してまいりました。本校が一貫して掲げております「誠実・勤勉・創造」の校訓は、単なる言葉としてではなく、生徒たち一人ひとりの日々の学校生活において具現化されるべき行動指針であり、知性・徳性・体力の三位一体となった調和のとれた全人教育を通じて、社会に貢献できる有為な人材の育成に、教職員一同、日夜努めております。\n\n本校の最大の特色といたしましては、${landmark}に象徴される、この地域ならではの豊かな自然環境と歴史的・文化的資源を最大限に活用した、他校には見られない特色ある教育活動を展開している点が挙げられます。生徒たちは、地域の方々との温かな交流を通じて、郷土への深い理解と愛着を育み、同時に社会性と豊かな人間性を身につけてまいります。また、このような地域に根ざした教育活動は、グローバル化が進展する現代社会において、自らのアイデンティティを確立し、世界に羽ばたいていくための確固たる基盤となるものと確信しております。\n\n昨今、社会は急速に変化しており、AI技術の発展をはじめとする技術革新により、私たちの生活様式や価値観は大きく変容しつつあります。このような変化の激しい時代において、本校では、生徒一人ひとりが自らの個性と可能性を最大限に発揮し、それぞれが抱く夢の実現に向けて主体的に学び続ける姿勢を育むことを、何よりも大切にしております。そのために、基礎学力の確実な定着はもちろんのこと、思考力・判断力・表現力といった、これからの時代を生き抜くために必要不可欠な資質・能力の育成に、教職員一同、全力を注いでおります。\n\nまた、本校では、ICT教育の充実、国際理解教育の推進、充実したキャリア教育など、時代の要請に応える先進的な教育プログラムの導入にも積極的に取り組んでおります。これらの取り組みを通じて、生徒たちが未来社会を切り拓いていくための確かな力を身につけられるよう、万全の体制を整えております。\n\n保護者の皆様、地域の皆様におかれましては、今後とも本校の教育活動に対しまして、変わらぬご理解とご支援を賜りますよう、心よりお願い申し上げます。`,
      ...
      face_image_url: 'https://placehold.co/300x300/333333/FFFFFF?text=Principal'
    },
    school_anthem: {
      title: `${schoolName}校歌`,
      lyrics: `朝日輝く この地に\n${landmark}仰ぎて 学び舎あり\n誠実勤勉 我らの誇り\n未来を拓く 若き力\n\n${landmark2}の 薫風に\n希望を胸に 進みゆく\nああ ${schoolName}\n我らが母校 永遠に`,
      ...
      club_activities: [
        {
          ...
          image_url: 'https://placehold.co/600x400/4A5568/FFFFFF?text=Brass+Band+Club'
        },
        {
          name: 'サッカー部',
          ...
          image_url: 'https://placehold.co/600x400/2D5016/FFFFFF?text=Soccer+Club'
        },
        {
          name: '茶道部',
          ...
          image_url: 'https://placehold.co/600x400/8B4513/FFFFFF?text=Tea+Ceremony+Club'
        }
      ],
      school_events: [
        {
          ...
          image_url: 'https://placehold.co/600x400/1E3A8A/FFFFFF?text=Entrance+Ceremony'
        },
        {
          name: '新入生歓迎遠足',
          date: '4月中旬',
          ...
          image_url: 'https://placehold.co/600x400/556B2F/FFFFFF?text=Welcome+Trip'
        },
        {
          name: '体育祭',
          date: '5月中旬',
          ...
          image_url: 'https://placehold.co/600x400/DC143C/FFFFFF?text=Sports+Festival'
        },
        {
          name: '夏季補習',
          date: '7月下旬〜8月上旬',
          ...
          image_url: 'https://placehold.co/600x400/FF8C00/FFFFFF?text=Summer+Classes'
        },
        {
          name: '文化祭',
          date: '9月中旬',
          ...
          image_url: 'https://placehold.co/600x400/FF69B4/FFFFFF?text=School+Festival'
        },
        {
          name: '芸術鑑賞会',
          date: '10月上旬',
          ...
          image_url: 'https://placehold.co/600x400/4169E1/FFFFFF?text=Art+Appreciation'
        },
        {
          name: '修学旅行',
          date: '10月下旬',
          description: `2年生が参加する修学旅行は、日本の歴史と文化に触れる貴重な機会です。京都・奈良方面を訪れ、寺社仏閣の見学や伝統工芸の体験を通じて、日本の心を学びます。`,
          image_prompt: 'Japanese high school students on school trip to Kyoto, temple visit, group photo, cultural experience, disposable camera, nostalgic atmosphere',
          image_url: 'https://placehold.co/600x400/4169E1/FFFFFF?text=School+Trip'
        },
        {
          name: 'マラソン大会',
          date: '12月上旬',
          ...
          image_url: 'https://placehold.co/600x400/87CEEB/000000?text=Marathon'
        },
        {
          name: '創立記念式典',
          date: '3月1日',
          ...
          image_url: 'https://placehold.co/600x400/800000/FFFFFF?text=Anniversary'
        },
        {
          name: '卒業証書授与式',
          date: '3月中旬',
          ...
          image_url: 'https://placehold.co/600x400/000080/FFFFFF?text=Graduation'
        }
      ],
      facilities: [
        {
          ...
          image_url: 'https://placehold.co/600x400/8B4513/FFFFFF?text=Principal+Office'
        },
        {
          name: '図書館「試練の書庫」',
          ...
          image_url: 'https://placehold.co/600x400/654321/FFFFFF?text=Library'
        },
        {
          name: '体育館兼避難所',
          ...
          image_url: 'https://placehold.co/600x400/708090/FFFFFF?text=Gymnasium'
        }
      ],
      monuments: [
        {
    ...
    teachers: [
      {
        name: '鬼塚猛',
        subject: '体育',
        description: '元自衛隊員。「生ぬるい」が口癖。サバイバル訓練の総責任者'
      },
      {
        name: '厳島礼子',
        subject: '国語',
        description: '見た目は優しそうだが、授業は容赦ない。古典の暗唱を徹底的に叩き込む'
      },
      {
        name: '岩山鉄也',
        subject: '地理',
        description: '本校OB。地形図の読み方を実地訓練で教える熱血教師'
      }
    ],
