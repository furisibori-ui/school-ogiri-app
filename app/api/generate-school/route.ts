...
`
    ...
    const userPrompt = `
先頭{。${locationContext}
地点の特性からキーカラーを決め、全画像プロンプトと制服に反映。固有名詞多数。大喜利は強めに・格調高くキャッチーに。校歌の歌詞には付近の川・海・地名をできる限り盛り込み地域の豊かさをアピール。校長325-420・overview130-160・教員90-130・卒業生45-65字。沿革(history)5〜7件を必ず出力。
`
