...
**⚠️ このように、固有名詞を見つけたら、その背景・歴史・役割を積極的に創作して文章に盛り込んでください。**
...
**合格例1**: 「〇〇駅から徒歩10分、〇〇商店街を抜けた〇〇公園の隣に位置する本校は、〇〇神社（江戸時代創建）や〇〇寺に囲まれた歴史ある学校です。生徒たちは勾配12度の〇〇坂を登って通学し、創業70年の〇〇書店や〇〇スーパーで買い物をし、〇〇カフェ（1995年開店）で友人と語らい、〇〇図書館（蔵書8万冊）で勉強に励んでおります。」
→ 固有名詞10個 + 推察した詳細情報✅

**合格例2（行事）**: 「毎年4月、〇〇駅南口に朝8時集合し、〇〇バス（路線番号32番）で〇〇公園まで向かいます。〇〇商店街の〇〇パン屋（創業1982年）でお弁当を購入し、〇〇神社の横にある広場で昼食をとります。午後は〇〇図書館の館長〇〇氏による地域史講座を受講し、帰路は〇〇橋を渡り、〇〇坂（通称：心臓破りの坂）を下って〇〇コンビニで飲み物を購入後、〇〇通りを経由して学校へ戻ります。」
→ 固有名詞15個 + 創作した詳細（創業年、路線番号、通称など）✅
...
2. **校長メッセージ**: 固有名詞15個以上必須（例：「〇〇駅から〇〇商店街を通り、〇〇神社や〇〇公園に囲まれた本校は...」）
3. **各行事**: 固有名詞8個以上必須（例：「〇〇駅から〇〇バスで〇〇公園に向かい、〇〇神社を参拝し、〇〇スーパーで昼食を購入...」）
4. **レビュー内容から地域の雰囲気や特徴を読み取り、学校の説明文に反映すること**
