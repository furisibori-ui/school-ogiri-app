...
/** LLMが principal_message / multimedia_content / school_anthem 等を school_profile 内に出力した場合、トップレベルに正規化 */
function normalizeSchoolDataStructure(data: SchoolData): SchoolData {
  ...
  // school_anthem: school_profile 内の方が歌詞が長い（完全版）ならそちらを優先
      ...
      monuments: [
        {
          ...
          image_prompt: 'Bronze statue of school founder, half realistic portrait half subtle abstract elements, traditional standing figure with modern artistic touch, cherry trees or garden in background, disposable camera aesthetic',
      ...
      uniforms: [
        {
          ...
          image_prompt: 'Full body shot, two Japanese high school students, one male one female, wearing same school uniform, pure white abstract minimal background, bold color scheme wine red and gold or coral and navy, Paris fashion week inspired design, formal pose side by side, distinctive blazer and details, disposable camera',
